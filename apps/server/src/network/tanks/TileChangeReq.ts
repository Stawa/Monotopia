...
export class TileChangeReq {
  ...
  //       return;
  //     }
  //     if (this.world.data.owner.id !== this.peer.data?.userID) {
  ...
  //       if (
  //         mainLock &&
  //         mainLock.lock?.ownerUserID !== this.peer.data?.userID
  //       ) {
  //         this.sendLockSound();
  //         return;
  //       }
  ...
  //           this.world.data.owner.id !== this.peer.data?.userID
  //         ) {
  //           this.peer.send(
  //             Variant.from(
  //               "OnTalkBubble",
  ...
  //           (b) =>
  //             b.lock?.ownerUserID &&
  //             b.lock.ownerUserID !== this.peer.data?.userID
  //         )
  //       ) {
  //         this.peer.send(
  //           Variant.from(
